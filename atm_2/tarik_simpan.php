...
<body>
    ...
    <div class="bg-primary p-5 rounded" style="margin: 75px 350px 0 350px;">
        <form action="proses/p_tarik_simpan.php" method="post">
            <div class="mb-2">
            ...
            <div class="d-grid gap-2">
                ...
                <button type="submit" class="btn btn-success" name="btn_tarik">Tarik saldo</button>
            </div>
        </form>
    </div>
</body>
