...
if (isset($_POST['btn_simpan'])) {
    ...
    $conn->query($query);
    echo "<script>alert('Saldo berhasil ditambahkan!'); window.location.href='../menu.php';</script>";
    ...
    if ($saldo_sekarang >= $jumlah) {
        ...
        $query = "UPDATE users SET saldo=$saldo_baru WHERE username='$username'";
        $conn->query($query);
        echo "<script>alert('Penarikan berhasil!'); window.location.href='../menu.php';</script>";
    } else {
